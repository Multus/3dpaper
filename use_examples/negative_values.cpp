...
int main() {
    ...
    Geodesic_line line2 = Geodesic_line(Point(0, 1000, 0), Point(500, 500, 400), Point(500, 500, 0));
    Geodesic_line line3 = Geodesic_line(Point(1000, 1000, 0), Point(1000, 1000, 0), Point(1000, 1000, 0));
    Geodesic_line line4 = Geodesic_line(Point(1000, 0, 0), Point(500, 500, -400), Point(500, 500, 0));
